...
readonly JOBS_AGENT_BIN="${JOBS_STATE_DIR}/bin/dotfiles-jobs-agent"   # the job's program; launchd keeps it alive
readonly JOBS_UNLOCK_NOTIFICATION="com.apple.screenIsUnlocked"          # a distributed notification, hence the agent
