...
// `dotfiles raycast link` widget reads the same generator and addresses an entry by the last segment of
...
// a dev extension). `dotfiles raycast link allow` writes them so the prompt never shows.
